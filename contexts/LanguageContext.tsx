...
const translations = {
  ko: {
    ...
    'locations.parnas.tel': '(전화번호 입력)',
    'locations.parnas.hours': '(운영시간 입력)',
    'locations.parnas.parking': '(주차 정보 입력)',
    'locations.parnas.transit': '(대중교통 안내 입력)',
    ...
    'locations.paradise.tel': '(전화번호 입력)',
    'locations.paradise.hours': '(운영시간 입력)',
    'locations.paradise.parking': '(주차 정보 입력)',
    'locations.paradise.transit': '(대중교통 안내 입력)',
    
    'locations.dtower.name': 'D-TOWER',
    'locations.dtower.sub': '광화문 디타워',
    'locations.dtower.address': '서울특별시 종로구 종로3길 17, 2층 5호 (청진동, 디타워)',
    'locations.dtower.tel': '(전화번호 입력)',
    'locations.dtower.hours': '(운영시간 입력)',
    'locations.dtower.parking': '(주차 정보 입력)',
    'locations.dtower.transit': '(대중교통 안내 입력)',

...
const translations = {
  ko: {
    ...
    'menu.item.bbq.wings.name': "Paulie's BBQ Wings",
            'menu.item.bbq.wings.desc': '폴리스 바비큐 윙스 바비큐 소스로 맛을 낸 치킨윙',
    ...
    'menu.item.white.pie.name': 'White Pie',
            'menu.item.white.pie.desc': '화이트파이 크림 소스, 모짜렐라, 리코타, 고르곤졸라, 파마산치즈, 꿀',
    ...
    'menu.item.devils.delight.name': 'Devil\'s Delight 🌶️',
            'menu.item.devils.delight.desc': '데블스 딜라이트 디아볼로 소스, 후레쉬 모짜렐라, 모짜렐라 치즈, 페퍼로니, 청양고추, 건고추, 꿀',
    'menu.item.pesto.chicken.name': 'Pesto Chicken',
            'menu.item.pesto.chicken.desc': '페스토 치킨 페스토소스, 모짜렐라, 닭고기, 체리토마토, 페타치즈, 마늘',
    ...
    'menu.item.shrimp.rosso.name': 'Shrimp Rosso 👍',
            'menu.item.shrimp.rosso.desc': '쉬림프 로쏘 고소한 크림소스와 새우, 베이컨이 들어간 리가토니 파스타',
    ...
    'menu.item.bolognese.diavolo.desc': '볼로네제 알라 디아블로 다진 소고기와 돼지고기가 들어있는 매콤하고 감칠맛 나는 디아블로 파스타',
    ...
    'menu.beer.ale.desc': '에일은 진한 향과 맛으로 상면발효 방식을 사용하는 영국식 맥주이며 맥주로 그 맛이 상당히 맑도록 하지만 모든 영국식 맥주이며 라거보다는 더 쓴 맥주입니다.',
    'menu.beer.stout.title': 'STOUT',
    'menu.beer.stout.desc': '스타우트는 아일랜드에서 시작된 상면발효맥주의 한 종류로, 진 맥주로 구운 맥아를 풍부하게 사용해서 검은색에 가까우며, 약간 쓴맛과 알코올 도수는 4~11%로 다양하고 홉(Hop)을 많이 사용해 맛이 진합니다.',

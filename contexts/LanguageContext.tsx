...
const translations = {
  ko: {
    ...
    'menu.item.godfather.desc': '**갓파더** 디아볼로 소스, 소고기, 마늘, 페퍼로니, 이탈리안 소시지, 모짜렐라, 양파, 할라피뇨',
    ...
    'menu.item.ny.supreme.name': 'NY Supreme 👍',
            'menu.item.ny.supreme.desc': '**뉴욕슈프림** 토마토 소스, 소고기, 이탈리안 소시지, 햄, 모짜렐라, 양파, 버섯, 올리브, 페퍼로니, 엄지',
    ...
    'menu.item.shrimp.rosso.name': 'Shrimp Rosso 👍',
            'menu.item.shrimp.rosso.desc': '**쉬림프 로제** 고소한 로제소스와 새우, 베이컨이 들어간 리가토니 파스타',
    ...
    'menu.item.bolognese.diavolo.desc': '**볼로네제 알라 디아볼로** 다진 소고기와 돼지고기가 들어있는 매콤하고 감칠맛 나는 디아블로 파스타',

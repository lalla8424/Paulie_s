...
const translations = {
  ko: {
    ...
    'about.feature2.description': '뉴욕 피제리아의 오븐을 그대로 재현한 대형 벽돌 오븐을 맞춤 제작하여 사용하고 있습니다. 500-600°F(약 260-315°C)의 고온에서 구워내는 피자는 겉은 바삭하고 속은 쫄깃한 완벽한 식감을 자랑합니다.',
    ...
    'about.quote': '폴리스 피제리아는 한국의 고객들에게 진정한\n뉴욕 핏자의 경험을 제공하는 것입니다.\n진짜 뉴욕피자를 만드는 폴리스 핏제리아는\n국내 최고의 정통 뉴욕 스타일 프리미엄 피자입니다.',
    ...
    'location.paradise': 'PARADISE CITY INCHEON',
    'location.paradise.korean': '인천 파라다이스시티',
    'location.paradise.address': '인천 중구 영종해안남로 321번길 186, F 204호, (운서동, 파라다이스시티)',
    ...
    'locations.paradise.name': 'PARADISE CITY',
    'locations.paradise.sub': '인천 파라다이스시티',
    'locations.paradise.address': '인천 중구 영종해안남로 321번길 186, F 204호, (운서동, 파라다이스시티)',
    'locations.paradise.tel': '032-729-5148',
    'locations.paradise.hours': '매일 11:30 - 22:00 (브레이크타임 15:00-17:00, 라스트오더 21:00)',
    'locations.paradise.parking': '주차 가능',
    'locations.paradise.transit': '파라다이스시티 플라자 내 2층',
    ...
    'locations.dtower.hours': '수-금 11:00-22:00 (브레이크타임 15:00-17:00), 토-일 11:30-22:00 (라스트오더 21:00)',
    ...
    'menu.item.honey.wings.desc': '허니 데킬라 윙 달콤하고 매콤한 데킬라 소스가 입힌 치킨 윙',
    'menu.item.buffalo.wings.name': 'Buffalo Hot Wings 🌶️',
    'menu.item.buffalo.wings.desc': '버팔로 핫 윙 버팔로 소스를 입혀 시큼하향이 코를 자극하는 가장 클래식한 치킨 윙',
    'menu.item.bbq.wings.name': "Paulie's BBQ Wings",
    'menu.item.bbq.wings.desc': '폴리스 바비큐 윙스 바비큐 소스 맛을 낸 치킨윙',
    ...
    'menu.item.pepperoni.desc': '페퍼로니 토마토 소스, 미국산 우리자녀 페퍼로니, 모짜렐라 치즈',
    'menu.item.godfather.name': 'Godfather 🌶️',
    'menu.item.godfather.desc': '갓파더 토마토 소스, 소고기, 마늘, 페퍼로니, 이탈리안 소시지, 모짜렐라, 양파, 할라피뇨',
    'menu.item.pepperoni.mushroom.name': 'Pepperoni & Mushrooms 👍',
    'menu.item.pepperoni.mushroom.desc': '페퍼로니&머쉬룸 토마토 소스, 페퍼로니, 모짜렐라 치즈, 버섯',
    'menu.item.ny.supreme.name': 'NY Supreme 🌶️',
    'menu.item.ny.supreme.desc': '뉴욕수프림 토마토 소스, 소고기, 이탈리안 소시지, 햄, 모짜렐라, 양파, 피망, 버섯, 올리브, 페퍼로니',
    ...
    'menu.item.white.pie.desc': '화이트파이 크림 소스, 모짜렐라, 리코타, 고르곤졸라, 파마산치즈, 골',
    'menu.item.spicy.cheddar.chicken.name': 'Spicy Cheddar Chicken 🌶️',
    'menu.item.spicy.cheddar.chicken.desc': '스파이시 체다 치킨 크림 소스, 모짜렐라, 체다 치즈, 닭고기, 햄, 베이컨, 양파, 버섯, 마늘, 할라피뇨',
    'menu.item.meatball.ricotta.name': 'Meatball & Ricotta',
    'menu.item.meatball.ricotta.desc': '미트볼&리코타 치즈 토마토 소스, 미트볼, 리코타치즈, 모짜렐라, 이탈리안 파슬리',
    'menu.item.bbq.chicken.name': 'BBQ Chicken',
    'menu.item.bbq.chicken.desc': '바비큐 치킨 바비큐 소스, 닭고기, 파인애플, 양파, 모짜렐라, 체다 치즈, 햄, 베이컨',
    ...
    'menu.item.devils.delight.desc': '데블스 딜라이트 토마토 소스, 후레쉬 모짜렐라, 모짜렐라 치즈, 페퍼로니, 청양고추, 간고추, 골',
    'menu.item.pesto.chicken.name': 'Pesto Chicken',
    'menu.item.pesto.chicken.desc': '페스토 치킨 페스토소스, 모짜렐라, 닭고기, 체리토마토, 체다치즈, 마늘',
    'menu.item.spicy.hawaiian.ricotta.name': 'Spicy Hawaiian with Ricotta',
    'menu.item.spicy.hawaiian.ricotta.desc': '스파이시 하와이안 리코타 토마토 소스, 햄, 파인애플, 할라피뇨, 모짜렐라 치즈, 리코타치즈, 바질',
    ...
    'menu.combo.3.desc': '뉴욕수프림 + 페퍼로니 & 머쉬룸',
    ...
    'menu.item.shrimp.rosso.desc': '쉬림프 로쏘 로제 소스와 새우, 베이컨이 들어간 리가토니 파스타',
    'menu.item.chicken.carbonara.name': 'Chicken Carbonara',
    'menu.item.chicken.carbonara.desc': '치킨 까르보나라 로쏘 파스타에 닭고기를 넣어 만든 화이트 파스타',
    'menu.item.bolognese.diavolo.name': 'Bolognese Alla Diavolo 👍',
    'menu.item.bolognese.diavolo.desc': '볼로네제 알라 디아볼로 다진 소고기와 돼지고기가 들어있는 매콤하고 감칠맛 나는 디아볼로 파스타',
    ...
    'menu.item.baked.spinach.chicken.desc': '베이크드 스피니치 치킨 크림소스에 시금치, 닭고기, 버섯, 양파와 함께 모짜렐라 치즈를 얹어 600°F의 브릭오븐에 구운 파스타',
    ...
    'menu.beer.lager.desc': '우리나라에서 제조되는 대부분의 맥주들이 라거 맥주이며 보온 청량감으로 톡 쏘고 시원한 맛이 일품인 맥주입니다.',
    'menu.beer.wheat.title': 'WHEAT',
    'menu.beer.wheat.desc': '보리 맥아 이외에 밀(Wheat)을 사용하여 풍부한 거품과 부시에 가까운 맥아맛을 내는 부드럽고 신선이 있는 맥주입니다.',
    ...
    'menu.beer.ale.desc': '에일은 진한 향과 맛으로 오랜 대륙 맥주로 그 맛이 상당히 맑도록 하지만 모든 영국식 맥주이며 라거보다는 더 쓴 맥주입니다.',
    'menu.beer.stout.title': 'STOUT',
    'menu.beer.stout.desc': '스타우트는 아일랜드에서 시작된 상면발효맥주의 한 종류로, 진 맥주로 구운 맥아를 풍부하게 사용해서 검은색에 가까우며, 약간 쓴맛과 4~11%로 다양하고 홉(Hop)을 많이 사용해 맛이 진합니다.',
    
    // Beer Menu Items
    'menu.beer.budweiser.name': 'Budweiser 5.0%',
    'menu.beer.budweiser.desc': 'ANHEUSER-BUSCH INBEV',
    'menu.beer.magpie.kolsh.name': '소량 한정 Magpie Kolsh 4.8%',
    'menu.beer.magpie.kolsh.desc': '까치양조장 쾰른 라거로 독일 바이에른의 금색 맥주 비어가드로 금색 전이 바뀌는 신기한 예쁘스타일 라거에요',
    'menu.beer.stella.name': 'Stella Artois 5.0%',
    'menu.beer.stella.desc': '스텔라 아르 홉을 사용해 쌉쌀한 목넘김 신만, 진한 꽃향을 느낄 수 있는 벨지어',
    'menu.beer.apricot.wheat.name': '소량 한정 Apricot Wheat 5.0%',
    'menu.beer.apricot.wheat.desc': '살구맛을 담아낸 밀째 성구, 복숭아의 맛과 향을 느낄 수 있는 휘트 에일 Lost Coast Brewery',
    'menu.beer.raspberry.wheat.name': '소량 한정 Raspberry Wheat 6.2%',
    'menu.beer.raspberry.wheat.desc': '크리미하고 새콤달콤한 라즈베리로 기쁨 한 몫 끝에서 톡 스타일 될 맥주 Gorilla Brewery',
    'menu.beer.weihenstephaner.name': '소량 한정 Weihenstephaner 5.4%',
    'menu.beer.weihenstephaner.desc': '바나나 향과 은은한 단맛, 직접한 바디감과 부드러운 밀감이 조화로운 될 맥주 바이어슈타펜',
    'menu.beer.gorilla.ipa.name': '소량 한정 Gorilla IPA 5.4%',
    'menu.beer.gorilla.ipa.desc': '감귤, 오렌지의 느낌 그리고 가벼운, 트로피 라이한 정말에 드라이고 홉 스파이시로 마무리되는 IPA',
    'menu.beer.indica.ipa.name': '소량 한정 Indica IPA 6.5%',
    'menu.beer.indica.ipa.desc': '시트러스한 지금, 홉, 홉부기의 맛복잡한 홉의 밸런스가 환상적인 IPA Lost Coast Brewery',
    'menu.beer.magpie.pale.ale.name': '소량 한정 Magpie Pale Ale 4.8%',
    'menu.beer.magpie.pale.ale.desc': '맑은 기능 느껴지는 월드라일러와 감귤류의 홉이가 맥주와에 쌉쌀한 끝맛이 특징, 깔끔하고 가벼운 바디감으로 맥주 맛을 맛이 좋기 좋은 맥주',
    'menu.beer.peanut.butter.name': '소량 한정 Peanut Butter 5.6%',
    'menu.beer.peanut.butter.desc': '피넛버터, 커피, 토피, 바닐라 체이의의 조화로 아름이 바삭하고 달지않게 마무리하는 맥주',
  ...
  en: {
    ...
    'location.paradise': 'PARADISE CITY INCHEON',
    'location.paradise.korean': 'Incheon Paradise City',
    'location.paradise.address': '186 Yeongjonghaeannam-ro 321beon-gil, Jung-gu, Incheon, F 204 (Unseo-dong, Paradise City)',
    'location.dtower': 'D-TOWER GWANGHWAMUN',
    ...
    'locations.paradise.name': 'PARADISE CITY',
    'locations.paradise.sub': 'Incheon Paradise City',
    'locations.paradise.address': '186 Yeongjonghaeannam-ro 321beon-gil, Jung-gu, Incheon, F 204 (Unseo-dong, Paradise City)',
    'locations.paradise.tel': '032-729-5148',
    'locations.paradise.hours': 'Daily 11:30 - 22:00 (Break Time 15:00-17:00, Last Order 21:00)',
    'locations.paradise.parking': 'Available',
    'locations.paradise.transit': 'Paradise City Plaza 2nd Floor',
    ...
    'locations.dtower.tel': '02-2251-8200',
    'locations.dtower.hours': 'Wed-Fri 11:00-22:00 (Break 15:00-17:00), Sat-Sun 11:30-22:00 (Last Order 21:00)',
    ...
    'menu.item.shrimp.rosso.name': 'Shrimp Rosso 👍',
    'menu.item.shrimp.rosso.desc': 'Rigatoni pasta with rosé sauce, shrimp, and bacon',
    'menu.item.chicken.carbonara.name': 'Chicken Carbonara',
    'menu.item.chicken.carbonara.desc': 'White pasta made with rosso pasta and chicken',
    'menu.item.bolognese.diavolo.name': 'Bolognese Alla Diavolo 👍',

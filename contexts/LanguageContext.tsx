...
const translations = {
  ko: {
    ...
    'menu.beer.jeju.citrus.lager.name': 'Jeju Citrus Lager 5.0%',
    'menu.beer.jeju.citrus.lager.desc': '시트러스한 귤과 한라봉의 향기를 느낄 수 있는 가벼운 라거',
  ...
  en: {
    ...
    'menu.beer.jeju.citrus.lager.name': 'Jeju Citrus Lager 5.0%',
    'menu.beer.jeju.citrus.lager.desc': 'A light lager with refreshing citrus notes of tangerine and Hallabong',
    'menu.beer.weihenstephaner.name': 'Weihenstephaner 5.4%',
